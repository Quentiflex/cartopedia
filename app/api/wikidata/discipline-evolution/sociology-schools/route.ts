...
const SCHOOL_OF_THOUGHT_IRI = "http://www.wikidata.org/entity/Q1387659";
...
SELECT ?item ?label ?description ?articleUrl WHERE {
  ?item wdt:P31 <${SCHOOL_OF_THOUGHT_IRI}> .
...
LIMIT ${limit}`.trim();
    ...
    return NextResponse.json({
      ...
      schoolType: { iri: SCHOOL_OF_THOUGHT_IRI, label: "school of thought" },
    ...
    const msg = err instanceof Error ? err.message : "Failed to fetch sociology schools";
